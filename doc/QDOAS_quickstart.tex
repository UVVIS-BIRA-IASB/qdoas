...
We start by defining cross section symbols matching the file names of the cross sections we want to fit (see table above): O3, NO2, NO2a, O4, H2O, Ring.  The file name should start with the symbol name (case insensitive), followed by an underscore.  A description can be added.  QDOAS needs these symbols for internal use.
...
\item \textbf{Residual}~: the normalized residual;
