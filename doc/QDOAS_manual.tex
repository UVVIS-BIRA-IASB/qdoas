...
\usepackage[docdef=restricted,automake,toc,nonumberlist]{glossaries-extra}
...
\begin{document}
\include{QDOAS_title}
\include{QDOAS_glossary}
\tableofcontents
\clearpage{\cleardoublepage}
\include{QDOAS_intro}
\include{QDOAS_interface}
\include{QDOAS_algorithms}
\include{QDOAS_quickstart}
\include{QDOAS_properties}
\include{QDOAS_tools}
\appendix
\include{QDOAS_inputfiles}
\include{QDOAS_output}
\include{QDOAS_troubleshooting}
\include{QDOAS_license}
